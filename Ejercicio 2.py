...
p1_formula = input("Ingrese la formula del partido 1: ")
p1_cant = int(input("ingrese cantidad de votos de partido !:"))
p2_formula = input("Ingrese la formula del partido 2: ")
p2_cant = int(input("Ingrese la cantidad de votos de partido 2: "))
p3_formula = input("ingrese formula del partido 3: ")
...
print("Formula con mayor porcentaje:", f1)
