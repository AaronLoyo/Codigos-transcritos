...
primer_numero = int(input("Ingrese la bolilla que salio (entre 1): "))
segundo_numero = int(input("Ingrese la bolilla que salio (entre 1): "))
tercer_numero = int(input("Ingrese la bolilla que salio (entre 1): "))

print("La tarjeta del usuario es: ", billete)
if primer_numero in billete or \
    segundo_numero in billete or tercer_numero in billete:
