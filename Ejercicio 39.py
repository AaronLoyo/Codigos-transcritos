...
print("Resultados")
print("= " * 40)
print(f"La sumatoria de los numeros entre 50 y 100 fue de {sumatoria}")
print(f"La cantidad de numeros pares procesados fue de {cantidad_pares}")
print(f"La cantidad de numeros impares procesados fue de {cantidad_impares}")
